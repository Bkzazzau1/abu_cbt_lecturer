...
import 'lecturer_assigned_exam_marking_panel.dart';
    ...
    return AnimatedBuilder(
      ...
      builder: (context, _) => AnimatedBuilder(
        ...
        builder: (context, _) {
          ...
          final metadata =
              selected == null ? null : _pdfService.metadataFor(selected);
          ...
          return Column(
            ...
            children: [
                        ...
                        SizedBox(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            decoration: const InputDecoration(
                              labelText: 'Assigned Exam Script PDF',
              ...
              const LecturerAssignedExamMarkingPanel(),
            ],
          );
        },
      ),
